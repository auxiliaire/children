...
import static com.personr.children.web.rest.TestUtil.sameInstant;
...
public class MealResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_INVENTED = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_INVENTED = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void createMeal() throws Exception {
        ...
        assertThat(testMeal.getInvented()).isEqualTo(DEFAULT_INVENTED);
    }
    ...
    @Test
    @Transactional
    public void checkInventedIsRequired() throws Exception {
        int databaseSizeBeforeTest = mealRepository.findAll().size();
        // set the field null
        meal.setInvented(null);
    ...
    public void getAllMeals() throws Exception {
        ...
        restMealMockMvc.perform(get("/api/meals?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].invented").value(hasItem(sameInstant(DEFAULT_INVENTED))));
    }
    ...
    public void getMeal() throws Exception {
        ...
        restMealMockMvc.perform(get("/api/meals/{id}", meal.getId()))
            ...
            .andExpect(jsonPath("$.invented").value(sameInstant(DEFAULT_INVENTED)));
    }
    ...
    public void updateMeal() throws Exception {
        ...
        assertThat(testMeal.getInvented()).isEqualTo(UPDATED_INVENTED);
    }
